...
class FuncoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcao" do
    assert_difference("Funcao.count") do
      post funcoes_url, params: { funcao: { descricao: @funcao.descricao, titulo: @funcao.titulo } }
    end
  ...
  test "should update funcao" do
    patch funcao_url(@funcao), params: { funcao: { descricao: @funcao.descricao, titulo: @funcao.titulo } }
